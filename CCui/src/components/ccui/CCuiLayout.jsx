...
import CCuiFileTree from './CCuiFileTree.jsx';
import CCuiChatInterface from './CCuiChatInterface.jsx';
...
const StatusBarItem = ({ icon: Icon, label, color = "text-[#b5b5b5]", active }) => (
