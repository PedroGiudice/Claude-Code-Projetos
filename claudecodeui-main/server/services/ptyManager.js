/**
 * PTY Manager Service
 * Handles pseudo-terminal (PTY) sessions for shell WebSocket connections
 */
import os from 'os';
import pty from 'node-pty';
import { WebSocket } from 'ws';

// PTY session storage and configuration
const ptySessionsMap = new Map();
const PTY_SESSION_TIMEOUT = 30 * 60 * 1000; // 30 minutes

/**
 * Get the PTY sessions map
 * @returns {Map} The PTY sessions map
 */
export function getPtySessionsMap() {
    return ptySessionsMap;
}
...
/**
 * Kill all PTY sessions (for cleanup)
 */
